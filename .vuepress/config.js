module.exports = {
  ...
  plugins: {
    ...
    'seo': {
      ...
      image: ($page, $site) => $page.frontmatter.image && (($site.themeConfig.domain || '') + $page.frontmatter.image) || 'https://placehold.jp/40//fff/600x315.png?css=%7B%22padding%22%3A%22%200%2080px%22%2C%22background-image%22%3A%22%20url(https%3A%2F%2Fplacehold.jp%2F057%2F333%2F130x40.png%3Ftext%3DDAYSPUT)"%7D&text='+encodeURIComponent($page.title||$site.title),
    }
  }
}